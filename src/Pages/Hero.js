...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-[90vh] flex items-center overflow-hidden -px-5 sm:-px-[5vw] md:-px-[5vw] lg:-px-[9vw]  ">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between w-full px-10">
        <motion.div 
        ...
        >
          <div className="gidole-regular">
            ...
            >
              ...
              <span className="text-sm text-blue-700 font-medium">Welcome to Gravitorix</span>
            </motion.div>
            ...
            >
              <button className="group bg-gradient-to-r from-blue-600 to-sky-600 hover:from-blue-700 hover:to-sky-700 text-white px-8 py-3 rounded-full font-medium transition-all duration-300 transform hover:scale-105 hover:shadow-xl flex items-center gap-2">
                Let's Get Started
                <ArrowRight className="group-hover:translate-x-1 transition-transform" size={18} />
              </button>
              <button className="border-2 border-blue-600 text-blue-600 hover:bg-blue-50 px-8 py-3 rounded-full font-medium transition-all duration-300">
                View Our Work
              </button>
            </motion.div>
        ...
        >
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-blue-100 to-transparent opacity-30 rounded-3xl"></div>
        </motion.div>
      </div>
